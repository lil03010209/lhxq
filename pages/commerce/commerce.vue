<template>
    <view class="number-display-container">
        <view class="header">商务</view>
        <view class="select-container">
                <view class="select-label">请选择您想要的类别：</view>
                <uni-data-select collection="class_list2" field="text as value, text as text" label="选择" v-model="name" :clear="false" @change="hChange" />
            </view>
        <view class="table">
...
.number-display-container {
    .header {
        background-image: url('https://mp-b85cac42-db73-45e0-8a58-4b70b36c42c6.cdn.bspapp.com/commerce.png'); // 设置背景图片
